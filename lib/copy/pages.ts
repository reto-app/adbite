...
const en = {
  about: {
    ...
    contactAfter: ' with anything, including the awkward questions about a pilot this small.',
  ...
  privacy: {
    ...
    sections: [
      ...
      ['Mail we send', 'Sign-in links, a note when a booking arrives for your shop, and a note when a shop has decided on your ad. No newsletters and nothing you did not ask for by using the product.'],
      ['Analytics', 'We count page views, which buttons get used, and whether a page was read rather than closed at once, so we can tell which parts of this site are confusing. It is aggregate and cookieless: no profiles, no cross-site tracking, no advertising pixels.'],
      ['Maps', 'The shop map loads tiles from OpenStreetMap, which means your browser makes a request to their servers and they see your IP address. Besides Supabase above, that is the only third party this site talks to.'],
    ] as [string, string][],
...
const es: typeof en = {
  about: {
    ...
    contactBefore: 'Escríbenos a ',
    contactAfter: ' con lo que sea, incluidas las preguntas incómodas sobre un piloto así de pequeño.',
  ...
  privacy: {
    ...
    sections: [
      ...
      ['Correos que enviamos', 'Enlaces de acceso, un aviso cuando llega una reserva para tu negocio, y un aviso cuando un negocio decide sobre tu anuncio. Sin boletines y sin nada que no hayas pedido al usar el producto.'],
      ['Analítica', 'Contamos visitas a la página, qué botones se usan, y si una página se leyó en vez de cerrarse de inmediato, para saber qué partes de este sitio confunden. Es agregado y sin cookies: sin perfiles, sin rastreo entre sitios, sin píxeles publicitarios.'],
      ['Mapas', 'El mapa de negocios carga imágenes de OpenStreetMap, lo que significa que tu navegador hace una solicitud a sus servidores y ellos ven tu dirección IP. Además de Supabase arriba, es el único tercero con el que habla este sitio.'],
    ] as [string, string][],
