...
const es: typeof en = {
  ...
  faqs: (f: Figures): [string, string][] => [
    ...
    ['¿Qué se puede comprar?', `Dos cosas. Un espacio permanente es un lugar, no una cantidad: un anuncio fijo en la franja debajo del menú de un negocio, en una pantalla, por un año. Un tablero tiene varios, se cotizan por pantalla y se acuerdan hablando, porque qué tableros tienen uno libre cambia cada semana. El video corto es tiempo: quince segundos sin sonido entre turnos del propio video del negocio, ${f.videoHour} por hora realmente mostrada, y lo paras cuando quieras.`],
