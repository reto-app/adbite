...
const en = {
  ...
  faqs: (f: Figures): [string, string][] => [
    ...
    ['What does a shop actually earn?', `Your board carries ${f.spots} permanent spots, each one sold to a local business for a year. Full, that is about ${f.yearly} a year to you, or ${f.weekly} a week, and it does not move with your footfall or your hours. Video runs on top of that and is paid by the minute it was on your screen. A second board doubles both.`],
...
const es: typeof en = {
  ...
  faqs: (f: Figures): [string, string][] => [
    ...
    ['¿Cuánto gana realmente un negocio?', `Tu tablero tiene ${f.spots} espacios permanentes, cada uno vendido a un negocio local por un año. Lleno, eso son cerca de ${f.yearly} al año para ti, o ${f.weekly} a la semana, y no cambia con tu clientela ni con tu horario. El video corre aparte y se paga por minuto mostrado. Una segunda pantalla duplica las dos cosas.`],
