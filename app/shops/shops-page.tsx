...
export function ShopsPage() {
  ...
  return <main>
    ...
    <section className="boards-section"><div className="wrap"><div className="section-head"><h2>{t.formats.title}</h2><p>{t.formats.lede}</p></div><BoardReel only={['rosas', 'spot']}/><div className="section-head reel-more"><h2>{t.more}</h2></div><BoardReel only={['roost', 'meridian']}/></div></section>
