...
const faqs: [string, string][] = [
  ...
  ['How much of the screen is advertising?', 'About a third. Your menu and your own content keep the rest, and the exact share is agreed with each shop: you can turn it down, or to nothing at all, any week you like. Menus and essential shop content always come first.'],
  ['What does a shop actually earn?', `It depends on your opening hours, because you are selling screen time. The one board running today is open ${SHOP.hours}, and is paid from about ${money.format(weeklyEarnings(SHOP))} a week. That figure is a floor: it assumes every minute sells as the smallest ad format. Weeks where the bigger formats sell run higher, up to around ${money.format(weeklyCeiling(SHOP))}. A shop open seven days, or running two screens, earns proportionally more.`],
