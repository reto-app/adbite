...
export default function Home() {
  ...
  return <main>
    ...
    <section className="formats"><div className="wrap"><div className="section-head format-head"><h2>Three ways an ad can show up.</h2><p>Every format leaves your own content in place, and every format is subject to your approval.</p></div><div className="format-grid"><article><div className="format-preview full" aria-hidden="true"><div className="fp-board"><b>TACOS</b><p>Carne asada <i>3.50</i></p><p>Al pastor <i>3.50</i></p><p>Pollo <i>3.25</i></p><p>Barbacoa <i>3.50</i></p></div><div className="fp-takeover"><span>FREEDOM CYCLES</span><b>Free tune-up with any repair</b><small>820 N Freedom Blvd · two blocks north</small></div></div><h3>Full-screen spot</h3><p>Your board blanks for one turn of the rotation, then it is back.</p></article><article><div className="format-preview video" aria-hidden="true"><div className="fp-frame one"><b>Iron Rose Gym</b></div><div className="fp-frame two"><b>First class free</b></div><div className="fp-frame three"><b>Two doors down</b><small>Open 5am to 10pm</small></div><span className="fp-timer">0:15</span><i className="fp-bar"/></div><h3>Short video</h3><p>Fifteen muted seconds. No sound to talk over.</p></article><article><div className="format-preview banner" aria-hidden="true"><div className="fp-board"><b>TACOS</b><p>Carne asada <i>3.50</i></p><p>Al pastor <i>3.50</i></p><p>Pollo <i>3.25</i></p></div><div className="fp-strip"><b className="one">Ninth Street Books · 10% off with your receipt</b><b className="two">Rosewood Barbers · walk-ins till seven</b><b className="three">Iron Rose Gym · first class free</b></div></div><h3>Bottom banner</h3><p>Your menu stays put. The strip below rotates between advertisers.</p></article></div></div></section>
